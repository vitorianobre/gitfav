...
export class FavoritesView extends Favorites {
    ...
    getInputUser() {
        this.root.querySelector('.search button').onclick = () => this.getUsername()

        document.addEventListener('keypress', (e) => {
            if (e.key === 'Enter') this.getUsername()
        })
    }
    ...
    emptyView() {
        ...
        if (isEmpty) {
            ...
            empty.innerHTML= `<svg width="57" height="54" viewBox="0 0 57 54" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            this.root.querySelector('.table-wrapper').append(empty)
